...
%% Initialiation
SubIdx=1;
FileIn=sprintf('%s/Healthy_%03d/Hong2014/curvatures/Health_%03d_GM_curvatres_Cmean_volume.nii.gz',DIRht1,SubIdx,SubIdx);
ImageIn_nii=load_untouch_nii(FileIn);
HDR=ImageIn_nii.hdr;

%% load mean
FileMean=sprintf('%s/Healthy_001/Hong2014/Mean_SD/Health_GM_curvatres_Cmean_volume_mean.nii.gz',DIRht1);
...
Istd_nii.hdr=HDR;
OutName=sprintf('%s/Healthy_001/Hong2014/Mean_SD/Health_GM_curvatres_Cmean_volume_std.nii.gz',DIRht1);
