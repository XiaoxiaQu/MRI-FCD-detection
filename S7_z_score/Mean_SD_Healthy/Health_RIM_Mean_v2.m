...
for Num=1:1:31
    if Num==1
        filename=sprintf('%s/Health_%03d/6_Features1/Health_%03d_affine_restore_RIM.nii.gz',Dir,Num,Num);
...
Num=1;
OutName=sprintf('%s/Health_%03d/7_Combine_Healthy_Controls/Health_restore_RIM_Mean_v2.nii.gz',Dir,Num);
