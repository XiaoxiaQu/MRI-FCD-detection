...
//----------------------------------------------------------------------------
       else if (region.IsInside(son_in.GetIndex()))
       {
          ...
          while ( (son_in.GetCenterPixel()>50) & (son_in.GetCenterPixel()<150) & (region.IsInside(son_in.GetIndex())) & (par_in.GetCenterPixel()>50) & (par_in.GetCenterPixel()<150) & (region.IsInside(par_in.GetIndex())))
          {
          //------------------------find son points-----------------------------------------
