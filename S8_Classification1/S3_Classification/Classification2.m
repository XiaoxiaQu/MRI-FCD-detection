...
% [13]label
    ...
    %%
    i=1;
    TestD(:,i)=Image2(:); i=i+1;
    TestD(:,i)=Image6(:);i=i+1;
  ...
  clear Image2  Image6
   ...
   %% Classify MRI data---Begin
    ...
    SEG1_nii=make_nii(SEG1); SEG1_nii.hdr=TissueSeg_nii.hdr;
      % save
    OutName1=sprintf('./Patient_%03d_GAMC2_SEG1.nii.gz',TestNumber);
    ...
    % save
    OutName2=sprintf('./Patient_%03d_GAMC2_SEG2.nii.gz',TestNumber);
    ...
    Evaluation_Name1=sprintf('./Patient_%03d_GAMC2_SEG1.csv',TestNumber);
...
Evaluation_Name2=sprintf('./Patient_GAMC2_SEG1_EVA.csv');
