...
//----------------------------------------------------------------------------
       else if (region.IsInside(son_in.GetIndex()))
       {
           ...
           C_Index=out.GetIndex(); // perserve the current index
             ...
             while ( (par_in.GetCenterPixel()>50) & (par_in.GetCenterPixel()<150) & (son_in.GetCenterPixel()>50) & (son_in.GetCenterPixel()<150) & (region.IsInside(son_in.GetIndex())) & (region.IsInside(par_in.GetIndex())))
